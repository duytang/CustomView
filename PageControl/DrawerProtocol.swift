...
protocol AdvancedPageControlDraw {
...
class AdvancedPageControlDrawerParentWithIndicator: AdvancedPageControlDrawerParent {
    var indicatorBorderColor: UIColor
    var indicatorBorderWidth: CGFloat
    var indicatorColor: UIColor
    init(numberOfPages: Int? = 5,
                height: CGFloat? = 16,
                width: CGFloat? = 16,
                space: CGFloat? = 16,
                raduis: CGFloat? = 8,
...
class AdvancedPageControlDrawerParent {
