//
//  PUCoverFlowLayout.swift
//  Blank
//
//  Created by Dii on 2/1/25.
//

import UIKit

enum PUCoverFlowLayoutSpacingMode {
    case fixed(spacing: CGFloat)
    case overlap(visibleOffset: CGFloat)
}

class PUCoverFlowLayout: UICollectionViewFlowLayout {
    ...
    @IBInspectable var sideItemScale: CGFloat = 0.6
    @IBInspectable var sideItemAlpha: CGFloat = 0.6
    @IBInspectable var sideItemShift: CGFloat = 0.0
    var spacingMode: PUCoverFlowLayoutSpacingMode = .fixed(spacing: 40)
